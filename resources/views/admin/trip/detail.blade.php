                        ...
                        <div class="driver-details">
                            ...
                            <div class="row">
                                <div class="col-12 paymentType mt-4 mb-5">
                                    <p class="d-flex align-items-center justify-content-end"><strong class="me-2">Payment Type:</strong> <span class="ptype d-flex align-items-center"><img src="{{asset('admin/assets/images/icons/cash-icon.svg')}}" alt="" class="img-fluid me-2"> Cash</span></p>
                                </div>
                            </div>                                        
                        </div>
                        <div class="row">
